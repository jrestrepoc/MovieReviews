...
# MEDIA settings (para archivos subidos por usuarios)
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_URL = '/media/'  # Corregido: era MEDIA_url (con u minúscula)
...
SECRET_KEY = 'django-insecure-qq1=^txn_8%4t^95*-ubcckigeqqu6l#y75tjyos3pw2(oiobe'
...
STATIC_URL = '/static/'  # Corregido: agregué la barra inicial
